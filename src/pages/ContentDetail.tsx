...
import { Star, Calendar, BookOpen, Plus, Heart, Trash2, RotateCcw, Monitor } from 'lucide-react';
  ...
  return (
    <div className="pb-20">
      ...
      <div className="h-[60vh] relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 max-w-7xl mx-auto flex items-end gap-8">
          <img 
          ...
          <div className="flex-1">
            ...
            <h1 className="text-5xl font-bold text-foreground mb-4">{item.title}</h1>
